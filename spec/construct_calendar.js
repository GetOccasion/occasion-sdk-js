describe('__constructCalendar()', function() {
  beforeEach(function() {
    ...
    moxios.stubRequest(
      /.+\/time_slots\/\?.*filter%5Bstarts_at%5D%5Bge%5D=2018-05-01.+/,
      JsonApiResponses.TimeSlot.calendar[0]
    )
    moxios.stubRequest(
      /.+\/time_slots\/\?.*filter%5Bstarts_at%5D%5Bge%5D=2018-05-08.+/,
      JsonApiResponses.TimeSlot.calendar[1]
    )
    moxios.stubRequest(
      /.+\/time_slots\/\?.*filter%5Bstarts_at%5D%5Bge%5D=2018-05-15.+/,
      JsonApiResponses.TimeSlot.calendar[2]
    )
    moxios.stubRequest(
      /.+\/time_slots\/\?.*filter%5Bstarts_at%5D%5Bge%5D=2018-05-22.+/,
      JsonApiResponses.TimeSlot.calendar[3]
    )
    moxios.stubRequest(
      /.+\/time_slots\/\?.*filter%5Bstarts_at%5D%5Bge%5D=2018-05-29.+/,
      JsonApiResponses.TimeSlot.calendar[4]
    )

    moxios.stubRequest(
      /.+\/time_slots\/\?.*filter%5Bstarts_at%5D%5Bge%5D=2018-05-09.+/,
      JsonApiResponses.TimeSlot.calendar[1]
    )
    moxios.stubRequest(
      /.+\/time_slots\/\?.*filter%5Bstarts_at%5D%5Bge%5D=2018-05-16.+/,
      JsonApiResponses.TimeSlot.calendar[2]
    )
    moxios.stubRequest(
      /.+\/time_slots\/\?.*filter%5Bstarts_at%5D%5Bge%5D=2018-05-23.+/,
      JsonApiResponses.TimeSlot.calendar[3]
    )
    moxios.stubRequest(
      /.+\/time_slots\/\?.*filter%5Bstarts_at%5D%5Bge%5D=2018-05-30.+/,
      JsonApiResponses.TimeSlot.calendar[4]
    )

    moxios.stubRequest(
      /.+\/time_slots\/\?.*filter%5Bstarts_at%5D%5Bge%5D=2018-06-01.+/,
      JsonApiResponses.TimeSlot.calendar[0]
    )
    moxios.stubRequest(
      /.+\/time_slots\/\?.*filter%5Bstarts_at%5D%5Bge%5D=2018-06-08.+/,
      JsonApiResponses.TimeSlot.calendar[1]
    )
    moxios.stubRequest(
      /.+\/time_slots\/\?.*filter%5Bstarts_at%5D%5Bge%5D=2018-06-15.+/,
      JsonApiResponses.TimeSlot.calendar[2]
    )
    moxios.stubRequest(
      /.+\/time_slots\/\?.*filter%5Bstarts_at%5D%5Bge%5D=2018-06-22.+/,
      JsonApiResponses.TimeSlot.calendar[3]
    )
    moxios.stubRequest(
      /.+\/time_slots\/\?.*filter%5Bstarts_at%5D%5Bge%5D=2018-06-29.+/,
      JsonApiResponses.TimeSlot.calendar[4]
    )

    moxios.stubRequest(
      /.+\/time_slots\/\?.*filter%5Bstarts_at%5D%5Bge%5D=2018-07-01.+/,
      JsonApiResponses.TimeSlot.calendar[0]
    )
    moxios.stubRequest(
      /.+\/time_slots\/\?.*filter%5Bstarts_at%5D%5Bge%5D=2018-07-08.+/,
      JsonApiResponses.TimeSlot.calendar[1]
    )
    moxios.stubRequest(
      /.+\/time_slots\/\?.*filter%5Bstarts_at%5D%5Bge%5D=2018-07-15.+/,
      JsonApiResponses.TimeSlot.calendar[2]
    )
    moxios.stubRequest(
      /.+\/time_slots\/\?.*filter%5Bstarts_at%5D%5Bge%5D=2018-07-22.+/,
      JsonApiResponses.TimeSlot.calendar[3]
    )
    moxios.stubRequest(
      /.+\/time_slots\/\?.*filter%5Bstarts_at%5D%5Bge%5D=2018-07-29.+/,
      JsonApiResponses.TimeSlot.calendar[4]
    )

    moxios.stubRequest(
      /.+\/time_slots\/\?.*filter%5Bstarts_at%5D%5Bge%5D=2018-08-01.+/,
      JsonApiResponses.TimeSlot.calendar[0]
    )
    moxios.stubRequest(
      /.+\/time_slots\/\?.*filter%5Bstarts_at%5D%5Bge%5D=2018-08-08.+/,
      JsonApiResponses.TimeSlot.calendar[1]
    )
    moxios.stubRequest(
      /.+\/time_slots\/\?.*filter%5Bstarts_at%5D%5Bge%5D=2018-08-15.+/,
      JsonApiResponses.TimeSlot.calendar[2]
    )
    moxios.stubRequest(
      /.+\/time_slots\/\?.*filter%5Bstarts_at%5D%5Bge%5D=2018-08-22.+/,
      JsonApiResponses.TimeSlot.calendar[3]
    )
    moxios.stubRequest(
      /.+\/time_slots\/\?.*filter%5Bstarts_at%5D%5Bge%5D=2018-08-29.+/,
      JsonApiResponses.TimeSlot.calendar[4]
    )
  })
  ...
  describe('no month arg', function() {
    beforeEach(function() {
      ...
      return (this.promise2 = this.promise.then(() => {
        ...
        return Occasion.__constructCalendar(undefined, {
    ...
    describe('nextPage()', function() {
      beforeEach(function() {
        this.promise3 = this.promise2.then(() => {
          return moxios.wait(() => {
            spyOn(Occasion, '__constructCalendar').and.callThrough()
            return this.calendarCollection.nextPage().then(collection => {
              collection.nextPage()
      ...
      it('preloads next month of timeSlots', function() {
        return this.promise3.then(() => {
          ...
          expect(
            Occasion.__constructCalendar.calls
              .all()
              [i].args[0].isSame(moment.tz('2018-08-01', this.product.merchant().timeZone))
          ).toBeTruthy()
        })
      })
      ...
      it('preloads next next month of timeSlots', function() {
        return this.promise3.then(() => {
          expect(
            Occasion.__constructCalendar.calls
              .mostRecent()
              .args[0].isSame(moment.tz('2018-09-01', this.product.merchant().timeZone))
          ).toBeTruthy()
        })
      })
  ...
  describe('with queryParams', function() {
    ...
    it('adds relation queryParams to query', function() {
      return this.promise2.then(() => {
        expect(moxios.requests.mostRecent().url).toContain(
          qs.stringify({ filter: { keywords: 'lorem', venue: '1,2' } })
        )
      })
    })
  })
  ...
  describe('options', function() {
    describe('status', function() {
      ...
      it('changes time slot status filter', function() {
        return this.promise2.then(() => {
          expect(moxios.requests.mostRecent().url).toContain(
            qs.stringify({ filter: { status: 'upcoming' } })
          )
        })
      })
