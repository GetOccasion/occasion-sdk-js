describe('Occasion.TimeSlot', function() {
  ...
  describe('constructCalendar(month, options)', function() {
    beforeEach(function() {
      ...
      moxios.stubRequest(
        /.+\/v1\/time_slots\/\?.*filter%5Bstarts_at%5D%5Bge%5D=2018-05-01.+/,
        JsonApiResponses.TimeSlot.calendar[0]
      )
      moxios.stubRequest(
        /.+\/v1\/time_slots\/\?.*filter%5Bstarts_at%5D%5Bge%5D=2018-05-08.+/,
        JsonApiResponses.TimeSlot.calendar[1]
      )
      moxios.stubRequest(
        /.+\/v1\/time_slots\/\?.*filter%5Bstarts_at%5D%5Bge%5D=2018-05-15.+/,
        JsonApiResponses.TimeSlot.calendar[2]
      )
      moxios.stubRequest(
        /.+\/v1\/time_slots\/\?.*filter%5Bstarts_at%5D%5Bge%5D=2018-05-22.+/,
        JsonApiResponses.TimeSlot.calendar[3]
      )
      moxios.stubRequest(
        /.+\/v1\/time_slots\/\?.*filter%5Bstarts_at%5D%5Bge%5D=2018-05-29.+/,
        JsonApiResponses.TimeSlot.calendar[4]
      )

      moxios.stubRequest(
        /.+\/v1\/time_slots\/\?.*filter%5Bstarts_at%5D%5Bge%5D=2018-06-01.+/,
        JsonApiResponses.TimeSlot.calendar[0]
      )
      moxios.stubRequest(
        /.+\/v1\/time_slots\/\?.*filter%5Bstarts_at%5D%5Bge%5D=2018-06-08.+/,
        JsonApiResponses.TimeSlot.calendar[1]
      )
      moxios.stubRequest(
        /.+\/v1\/time_slots\/\?.*filter%5Bstarts_at%5D%5Bge%5D=2018-06-15.+/,
        JsonApiResponses.TimeSlot.calendar[2]
      )
      moxios.stubRequest(
        /.+\/v1\/time_slots\/\?.*filter%5Bstarts_at%5D%5Bge%5D=2018-06-22.+/,
        JsonApiResponses.TimeSlot.calendar[3]
      )
      moxios.stubRequest(
        /.+\/v1\/time_slots\/\?.*filter%5Bstarts_at%5D%5Bge%5D=2018-06-29.+/,
        JsonApiResponses.TimeSlot.calendar[4]
      )

      moxios.stubRequest(
        /.+\/v1\/time_slots\/\?.*filter%5Bstarts_at%5D%5Bge%5D=2018-07-01.+/,
        JsonApiResponses.TimeSlot.calendar[0]
      )
      moxios.stubRequest(
        /.+\/v1\/time_slots\/\?.*filter%5Bstarts_at%5D%5Bge%5D=2018-07-08.+/,
        JsonApiResponses.TimeSlot.calendar[1]
      )
      moxios.stubRequest(
        /.+\/v1\/time_slots\/\?.*filter%5Bstarts_at%5D%5Bge%5D=2018-07-15.+/,
        JsonApiResponses.TimeSlot.calendar[2]
      )
      moxios.stubRequest(
        /.+\/v1\/time_slots\/\?.*filter%5Bstarts_at%5D%5Bge%5D=2018-07-22.+/,
        JsonApiResponses.TimeSlot.calendar[3]
      )
      moxios.stubRequest(
        /.+\/v1\/time_slots\/\?.*filter%5Bstarts_at%5D%5Bge%5D=2018-07-29.+/,
        JsonApiResponses.TimeSlot.calendar[4]
      )
  ...
  describe('duration', function() {
    beforeEach(function() {
      ...
      this.occsnClient.TimeSlot.first().then(window.onSuccess)
